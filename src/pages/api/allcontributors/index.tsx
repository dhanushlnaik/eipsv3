...
if (!githubToken) {
  throw new Error("GitHub access token (ACCESS_TOKEN) is not defined in the environment variables");
}
...
async function fetchContributors(url: string, headers: Record<string, string>, allContributors: Contributor[] = []): Promise<Contributor[]> {
