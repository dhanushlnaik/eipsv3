          ...
          >
            {filteredAuthors.map((result, index) => (
              <option
                ...
                className={`py-2 px-4 hover:bg-purple-700/50 ${
                  selectedIndex === index ? "bg-purple-700/80 font-semibold" : ""
                }`}
              >
            ...
            {uniqueResults.map((result, index) => (
              <option
                ...
                className={`py-2 px-4 hover:bg-purple-700/50 ${
                  selectedIndex === filteredAuthors.length + index ? "bg-purple-700/80 font-semibold" : ""
                }`}
              >
            ...
            {filteredIssueResults.map((result, index) => (
              <option
                ...
                className={`py-2 px-4 hover:bg-purple-700/50 ${
                  selectedIndex === filteredAuthors.length + uniqueResults.length + index ? "bg-purple-700/80 font-semibold" : ""
                }`}
              >
            ...
            {filteredEIPResults.map((result, index) => (
              <option
                ...
                className={`py-2 px-4 hover:bg-purple-700/50 ${
                  selectedIndex === filteredAuthors.length + uniqueResults.length + filteredIssueResults.length + index
