    ...
    <div className="relative w-full lg:w-1/2 max-w-xl">
      ...
      <div className="relative flex flex-col items-start justify-end overflow-hidden rounded-2xl border border-gray-800 bg-gray-900 px-6 py-8 shadow-xl">
        ...
        <p className="text-base font-normal text-slate-400 text-justify leading-relaxed mb-4">
          ...
          <Link href="https://eipsinsight.com/eips/eip-7600" target="_blank" className="text-blue-400 underline hover:text-blue-300 transition">
            Pectra
          </Link>
          . This upgrade will involve significant changes to both the{" "}
          <Link href="https://www.youtube.com/watch?v=nJ57mkttCH0" target="_blank" className="text-blue-400 underline hover:text-blue-300 transition">
            Execution and Consensus layers
          </Link>{" "}
          on the mainnet. Given the complexities of testing and the scope of changes, including 11{" "}
          <Link href="https://www.youtube.com/watch?v=AyidVR6X6J8" target="_blank" className="text-blue-400 underline hover:text-blue-300 transition">
            Ethereum Improvement Proposals (EIPs)
          </Link>
          , the developers recently decided to reduce the scope of the Pectra upgrade. Some EIPs have now been shifted to the upcoming{" "}
          <Link href="https://eipsinsight.com/eips/eip-7600" target="_blank" className="text-blue-400 underline hover:text-blue-300 transition">
            Fusaka
          </Link>{" "}
          (a combination of Fulu and Osaka) upgrade. Currently, the testing team is working on{" "}
          <Link href="https://notes.ethereum.org/@ethpandaops/pectra-devnet-5" target="_blank" className="text-blue-400 underline hover:text-blue-300 transition">
            Devnet 5
          </Link>{" "}
          and has finalized the specifications for Devnet 4. Specs and other details can be followed below.{" "}
          <Link href="#carousel-section" className="text-blue-400 underline hover:text-blue-300 transition">
            View more
          </Link>.
        </p>
        <Meteors number={20} />
