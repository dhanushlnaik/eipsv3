...
import RIPStatusDonut from '@/components/charts/RIPStatusDonut';
import RIPTypeDonut from '@/components/charts/RIPTypeDonut';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
    ...
    <div className="min-h-screen flex flex-col bg-[#0F172A]">
      <main className="flex-grow px-5 sm:px-10">
        <div className="pt-20 w-full mx-auto">
          ...
          >
            {`Rollup Improvement Proposal - [ ${data.length} ]`}
          </motion.div>
          <motion.div
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                A Rollup Improvement Proposal (RIP) is a formal document that
                outlines new features, processes, or optimizations for rollup
                solutions in the Ethereum ecosystem. RIPs act as specifications
                to improve rollups, enhance interoperability, and standardize
                development processes. All RIPs are optional. RIPs are and will
                always remain optional standards for Rollups and participants in
                the larger EVM ecosystem.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>Why are RIPs Important?</AccordionTrigger>
              <AccordionContent>
                A Rollup Improvement Proposal (RIP) is a formal document that
                outlines new features, processes, or optimizations for rollup
                solutions in the Ethereum ecosystem. RIPs act as specifications
              ...
              <Tabs defaultValue="type" className="w-full ">
                ...
                <TabsContent value="status">
                  <div className="grid grid-cols-1 lg:grid-cols-3 pt-8 gap-5">
                    ...
                    <div className="h-fit">
                      <EIPStatusBar type="RIP" />
                    </div>
                  </div>
                  <div className="mt-6">
                    <DraftvFinalBar type="RIPs" />
                  </div>
                  <div className="mt-6">
                    {[
                      'Draft',
