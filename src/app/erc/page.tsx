...
import ERCTypeDonut from '@/components/charts/ERCTypeDonut';
import EIPTypeBar from '@/components/charts/EIPTypeBar';
import ERCStatusDonut from '@/components/charts/ERCStatusDonut';
...
import ERCStatusGraph from '@/components/charts/ERCStatusGraph';
    ...
    <div className="min-h-screen flex flex-col bg-[#0F172A]">
      <main className="flex-grow px-5 sm:px-10">
        <div className="pt-20 w-full mx-auto">
          ...
          >
            {`Ethereum Request for Comment -      [ ${data.length} ]`}
          </motion.div>
          <motion.div
          ...
          >
            {
              'ERCs describe application-level standard for the Ethereum ecosystem.'
            }
          </motion.div>
              ...
              <Tabs defaultValue="type" className="w-full ">
                ...
                <TabsContent value="status">
                  <div className="grid grid-cols-1 lg:grid-cols-3 pt-8 gap-5">
                    ...
                    <div className="h-fit">
                      <EIPStatusBar type="ERC" />
                    </div>
                  </div>
                  <div className="mt-6">
                    <DraftvFinalBar type="ERCs" />
                  </div>
                  <div className="mt-6">
                    {[
                      'Draft',
